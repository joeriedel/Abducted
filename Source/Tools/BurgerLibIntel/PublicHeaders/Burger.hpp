...
public:
	FontRef_c(Word FontNum=0,const Word8 *PalPtr=CurrentPalette) {FontInit(this,FontNum,PalPtr);}
	~FontRef_c() {ReleaseAFont2(this);}
	FontRef_c *New(Word FontNum=0,const Word8 *PalPtr=CurrentPalette) {return (FontRef_c*)FontNew(FontNum,PalPtr);}
	void Delete(void) {FontDelete(this);}
	void Init(Word FontNum=0,const Word8 *PalPtr=CurrentPalette) {FontInit(this,FontNum,PalPtr);}
	...
	void Install(Word FontNum,const Word8 *PalPtr=CurrentPalette) {InstallAFontToPalette2(this,FontNum,PalPtr);}
	void Release(void) {ReleaseAFont2(this);}
	void SetRGBList(const void *RGBList,const Word8 *PalPtr=CurrentPalette) {FontSetColorRGBListToPalette2(this,RGBList,PalPtr);}
};
