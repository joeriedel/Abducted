...
extern void BURGERCALL InitTimer8Irq(void);
extern Word BURGERCALL MyIrq8(void);
#ifdef __cplusplus
}
#endif
...
void BURGERCALL UninstallTick(void)
{
	if (OldInt8) {
		outp(0x43,0x36);				/* Change timer 0 */
		outp(0x40,0);
...
static void BURGERCALL InstallTick(void)
{
	Word32 speed;
