...
Arm.active = false
Arm.Chats = {}
Arm.IntroAnimationSpeedScale = 0.50
...
function Arm.SpawnShared(self)
	...
	self.gfx.SkillsVertLines3 = World.Load("UI/straight3_M")
	...
	self.typefaces.LogSkillPoints = World.Load("UI/LogSkillPoints_TF")
	...
	self.sfx.OmegaUpgrade = World.Load("Audio/omegaupgrade")
